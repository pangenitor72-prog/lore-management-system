...
class GameConfig(BaseModel):
    ...
    - ONE_SHOT scope (AI drives to climax in ~20 turns)
    """
    ...
    # SCOPE: Duration. ONE_SHOT = AI drives to climax (~20 turns). CAMPAIGN = endless open world
    session_scope: Literal["ONE_SHOT", "CAMPAIGN"] = "ONE_SHOT"

    # Pacing thresholds for ONE_SHOT mode
    climax_start_turn: int = 15
    max_turns: int = 20
