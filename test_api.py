...
results = []
test_data = {} # To store data needed for subsequent tests
...
with open(upload_file_path, "rb") as f:
    # The 'files' parameter for requests takes a list of tuples for multiple files:
    # [('files', (filename, file-object, content-type)), ...]
    ...
    if passed and response:
        # Optional: Verify file exists. For now, a 200 OK is sufficient.
        pass
